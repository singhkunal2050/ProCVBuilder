...
function Hero() {
  return (
    <header>
      <div className="flex flex-col justify-center items-center py-20 md:py-40 bg-[url('//source.unsplash.com/600x700?job')] bg-cover bg-emerald-900 bg-blend-multiply ">
        <Container>
