...
function Benefits() {
  return (
    <div className='py-14 bg-gray-100 dark:bg-slate-700'>
    <Container>
        <h1 className="text-3xl md:text-5xl font-bold pb-8 text-center">Benefits</h1>

        <section className='grid grid-cols-1 md:grid-cols-4 gap-8'>

          <div className='flex flex-col items-center justify-center bg-gray-100 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-gray-800 p-6 bottom-1 shadow-lg'>
